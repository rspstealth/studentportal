                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <th class="name_col" scope="col">From Date</th>
                                            <th class="name_col" scope="col">To Date</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr class="record_row record_{{ $holiday->id }}">
                                                    ...
                                                    <td>{{ \Carbon\Carbon::createFromTimeStamp(strtotime($holiday->from_date))->format('d-m-Y')  }}</td>
                                                    <td>{{ \Carbon\Carbon::createFromTimeStamp(strtotime($holiday->to_date))->format('d-m-Y') }}</td>
                                                    <td>
