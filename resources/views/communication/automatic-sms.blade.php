            ...
            <div id="right-content" class="col-md-10">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <h3 class="">Automatic SMS @can('create-resources',\Illuminate\Support\Facades\Auth::user())<a style="float:right;" href="#" id="new_task_btn" title="Add New SMS Template" class="btn btn-primary "><i class="far fa-envelope"></i> New SMS Template</a>@endcan</h3>
                    ...
                    <div class="col-md-12">
                        <div id="filters_action">
                            <form class="row" id="resources_filters_action_form" style="height:76px;margin: 0;" action="{{url('communication/automatic-sms/list')}}/{{$page_var}}" method="GET">
                                {{ csrf_field() }}
                                <div class="col-md-4">
                                    Filter by Status
                    ...
                    <form id="edit_course_form" action="{{url('communication/automatic-sms/')}}/{{$page_var}}" method="POST">
                        {{ csrf_field() }}
                            <div class="col-md-12">
                                <div id="actions_bar">
                                ...
                                <table class="table resources_table">
                                    ...
                                    @foreach($automatic_sms as $automatic_sms)
                                        <tr class="record_row record_{{ $automatic_sms->id }}">
                                            <td class="checkbox_container checkbox_col">
                                                <input class="task_checkbox checkbox" id="{{ $automatic_sms->id }}" value="{{ $automatic_sms->id }}" name="delete_checkbox" type="checkbox"/>
                                                <span class="checkmark"></span>
                                            </td>
                                            <td>{{ $automatic_sms->title  }}</td>
                                            <td>{{ ($automatic_sms->is_active ? 'Active' : 'Inactive')  }}</td>
                                            <td><a id="edit_action_{{ $automatic_sms->id }}" class="action_buttons edit_action btn-outline-secondary tiny-action-btn" href="#" title="Edit"><i class="fas fa-edit"></i> Edit Template</a></td>
                                        </tr>
                                        <?php $count++;?>
                                    @endforeach
                                    <?php
                                ...
                                <div id="filters_out_form" class="col-md-12 text-right" style="margin-top: 16px;">
                                    ...
                                    if($page_var > 1){
                                    ?>
                                    <a class="action_buttons" href="{{url('communication/automatic-sms/list/')}}/{{$page_var-1}}?_token={{ csrf_token() }}&template_status_filter={{((Request::query('template_status_filter')) ? Request::query('template_status_filter') : "" )}}" title="Previous"><i class="fas fa-chevron-left"> </i> Previous</a>
                                    <?php
                                    }
                                    ?>
                                    <?php
                                    ...
                                    ?>
                                    <a class="action_buttons" href="{{url('communication/automatic-sms/list/')}}/{{$page_var+1}}?_token={{ csrf_token() }}&template_status_filter={{((Request::query('template_status_filter')) ? Request::query('template_status_filter') : "" )}}" title="Next">Next <i class="fas fa-chevron-right"></i></a>
                                    <?php
                                    }
                                    }
                                    ?>
                        ...
                        <div class="delete-modal-dialog modal_delete_dialog" role="document">
                            <div class="modal-content align-items-center">
                                ...
                                <div class="modal-footer">
                                    <form id="del_selected_form" action="{{url('communication/automatic-sms/list')}}/{{$page_var}}" method="POST">
                                        {{ method_field('delete') }}
                                        {{ csrf_field() }}
                    ...
                    <div id="modal_task_action" class="modal modal_task_action" tabindex="-1" role="dialog">
                        <div class="task-modal-dialog modal_task_dialog" style="    width: 50%;    left: 25%;    margin-top: 2% !important;" role="document">
                            <div class="modal-content align-items-center" style="padding: 0 20px;">
                                <div class="modal-body">
                                    <h3>New SMS Template <a href="#" title="close dialog" id="close_dialog" style="float: right;margin: 0 10px;"><i class="fa fa-close"></i></a></h3>
                                </div>
                                <div class="modal-footer">
                                    <form id="add_template_form" action="{{url('communication/automatic-sms/list/')}}/{{$page_var}}" method="POST">
                                        {{ csrf_field() }}
                                        <div class="col-md-12 no-padding">
                                            <div class="col-md-12 no-padding">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        SMS Body <i class="fas fa-asterisk"></i>
                                                        <textarea id="sms" name="sms" class="form-control lb-lg" cols="1" rows="12"></textarea>
                                                        <small class="text-danger error_msg" id="sms_errors"></small>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="total" name="total" value="{{$total}}" />
                                        <input type="hidden" id="totalPages" name="totalPages" value="{{$totalPages}}" />
                                        <input type="hidden" id="method" name="method" value="new_sms_template" />
                                        <input type="hidden" id="page_var" name="page_var" value="{{$page_var}}" />
                                        <div class="col-md-12">
                                            <label>Shortcodes</label>
                                            <hr style="margin:0;padding:5px;"/>
                                            <h4 style="padding:5px 0;margin:0;">{first_name} {last_name} {sms} {password} {recommendation_1} {recommendation_2} {recommendation_3}</h4>
                                            <hr/>
                                            <input class="btn btn-primary" type="submit" id="new_template_btn" name="new_template_btn" value="Add SMS Template" />
                        ...
                        <div class="template-modal-dialog modal_template_dialog" style="    width: 70%;    left: 15%;    margin-top: 2% !important;" role="document">
                            <div class="modal-content align-items-center" style="padding: 0 20px;">
                                <div class="modal-body" style="padding: 0;">
                                    <h3>Edit SMS Template <a href="#" title="close dialog" id="close_edit_dialog" style="float: right;margin: 0 10px;"><i class="fa fa-close"></i></a></h3>
                                </div>
                                <div class="modal-footer">
                                    <form id="edit_template_form" action="{{url('communication/automatic-sms/list/')}}/{{$page_var}}" method="POST">
                                        {{ csrf_field() }}
                                        <div class="col-md-12 no-padding">
                                            <div class="col-md-12 no-padding">
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        SMS Body <i class="fas fa-asterisk"></i>
                                                        <textarea id="edit_sms" name="edit_sms" class="form-control lb-lg" cols="1" rows="5"></textarea>
                                                        <small class="text-danger error_msg" id="edit_sms_errors"></small>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="method" name="method" value="edit_sms_template" />
                                        <input type="hidden" id="total" name="total" value="{{$total}}" />
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <h4 style="padding:5px 0;margin:0;">{first_name} {last_name} {sms} {password} {recommendation_1} {recommendation_2} {recommendation_3}</h4>
                                            <hr/>
                                            <input class="btn btn-primary" type="submit" id="edit_template_btn" name="edit_template_btn" value="Update SMS Template" />
...
<script>
    (function(){
        ...
        $(".edit_action").on("click", function (e) {
            ...
            $.ajax({
                url: '{{ url('/get-template-by-id-ajax') }}',
                type: 'get',
                data:'edit_template_id='+id[2]+'&method=edit_sms_template',
                processData: false,
                contentType: false,
        ...
        $("#edit_template_btn").click(function (e) {
            ...
            if ($('#edit_sms').val().length <= 0) {
                $('#edit_sms_errors').text('Please provide sms body');
                return false;
            } else {
                $('#edit_sms_errors').text('');
            }
            ...
            $.ajax({
                url: '{{ url('/communication/automatic-sms/list/').'/'.$page_var }}',
                type: 'POST',
                data: formdata,
                processData: false,
                contentType: false,
                success: function (response) {
                    ...
                    $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                        ...
                        var page = '{{url("/")}}/communication/automatic-sms/list/{{$page_var}}';
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                        $("#success-alert").css("height", "0px");
                        $("#success-alert").css("display", "block");
                        var page = '<?php echo url("/")?>'+'/communication/automatic-sms/list/<?php echo $page_var;?>';
                        window.location.href = page // Go
                    });
                },
                error: function (data) {
        ...
        //check for unique sms template title
        $('#title').on('input', function (e) {
            ...
            $.ajax({
                url: '{{ url("/check-if-sms-template-already-exists-ajax") }}',
                type: 'get',
                data: 'title=' + title,
                processData: false,
                contentType: false,
                success: function (response) {
                    ...
                    if (response === 'exists') {
                        $('#title_errors').html('SMS template already exists, please use different title.')
                        return false;
                    }
                    if (response === 'unique') {
                        $('#title_errors').html('')
