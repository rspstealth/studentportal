            ...
            <div id="right-content" class="col-md-10">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <h3 class="">Tasks @can('create-tasks',\Illuminate\Support\Facades\Auth::user())<a style="float:right;" href="#" id="new_task_btn" title="Add New Task" class="btn btn-primary "><i class="fas fa-plus"></i> New Task</a>@endcan</h3>
                            ...
                            <form class="row" id="filters_action_form" style="height:56px; margin: 0;" action="{{url('/task-management/list')}}/{{$page_var}}" method="GET">
                                ...
                                <div class="col-md-3">
                                    <select id="staff_filter" name="staff_filter" class="form-control">
                                        <option value="">Sort by staff</option>
                                        <?php
                                        foreach($tutors as $tutor){
                                        ?>
                                        <option {{(Request::query('staff_filter') == $tutor->user_id)? 'selected=""':''}} value="{{$tutor->user_id}}">{{$tutor->first_name}} {{$tutor->last_name}}</option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div id="actions_bar">
                                    <div id="actions_bar_left">
                                        ...
                                        <a class="btn btn-outline-secondary tiny-action-btn" href="#" id="multiple_resolve_select" title="Resolve Selected Tasks"><i class="fas fa-wrench"></i> Resolve Selected</a>
                                ...
                                <table class="table tasks_table">
                                    ...
                                    <?php
                                        ...
                                        echo '<tr><td colspan="7"> No Task Found </td></tr>';
                                    }
                                    ?>
                                    </tbody>
                                </table>
