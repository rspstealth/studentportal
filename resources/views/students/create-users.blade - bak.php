                        ...
                        if (response !== 'NULL') {
                            ...
                            tutors.forEach(function(tutor){
                                //if(!('user_email_item_'+tutor["id"] in selectedEmails)){
                                    ...
                                    data_holder += '<a href="#!" onclick="($(\'#current_course_tutor\').val($(this).html()));">'+tutor["first_name"]+' '+tutor["last_name"]+'</a>';
                                //}
                    ...
                    success: function (response) {
                        if (response !== 'NULL') {
                            ...
                            tutors.forEach(function(tutor){
                                //if(!('user_email_item_'+tutor["id"] in selectedEmails)){
                                console.log("Key Exists:"+ tutor["id"]);
                                data_holder += '<a href="#!" onclick="($(\'#secondary_course_tutor\').val($(this).html()));">'+tutor["first_name"]+' '+tutor["last_name"]+'</a>';
                                //}
