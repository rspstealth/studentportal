                            ...
                            <div class="table student_list_table">
                                ...
                                <div class="col-md-12 no-padding tablerow">
                                    <div class="col-md-3">{{ $student->first_name .' '. $student->last_name }}
                                        ...
                                        <?php
                                        if(App\Http\Controllers\UserController::getUserRole(auth()->user()->id) == 'admin' OR App\Http\Controllers\UserController::getUserRole(auth()->user()->id) == 'tutor'){
                                        ?>
                                    ...
                                    <div class="col-md-2 no-padding">
                                        <a href="#!" class="btn btn-outline-secondary" id="toggle_{{$student->id}}"
                                           onclick="showStudentCourses({{$student->id}})">SW <i
                                                    class="fas fa-angle-double-down"></i></a>
                                        <a href="#!" class="btn btn-outline-secondary" id="review_courses_btn_{{$student->id}}"
                                           onclick="showReviewCourses({{$student->id}})">RC <i
...
{{--                                                        </div>--}}
                            ...
                            {{--Edit Admin modal--}}
                            <div id="modal_review_courses_action" class="modal modal_review_courses_action" tabindex="-1" role="dialog">
                                <div class="review-courses-modal-dialog modal_review_courses_dialog" role="document">
                                    <div class="modal-content align-items-center" style="padding: 0 20px;">
                                        <div class="modal-body">
                                            <h3>Student Account Details <a href="#" title="close dialog" id="close_review_courses_dialog" style="float: right;margin: 0 10px;"><i class="fa fa-close"></i></a></h3>
                                        </div>
                                        <div class="modal-footer">
                                            <form style="text-align:left;" id="edit_student_profile_form" action="{{url('/students/list/')}}/{{$page_var}}" method="POST">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="col-md-12">
                                                    <hr/>
                                                    <input class="btn btn-primary" type="submit" id="confirm_student_profile_edit" name="confirm_student_profile_edit" value="Update" />
                                                    <button type="button" id="cancelled_review_courses" class="btn btn-outline-secondary ">Cancel</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <form id="add_upload_for_marking_form"
                                            ...
                                            <div class="col-md-12 no-padding">
                                                <div class="col-md-12 no-padding">
                                                    <div class="col-md-12 no-padding">
                                                        <div class="form-group">
                                                            <h4 style="padding:5px 0" id="marking_course_name">Course Name</h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 no-padding">
                                                        <div class="form-group">
                                                            <h4 style="padding:5px 0" id="marking_student_name">Student Name</h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 no-padding">
                                                        <div class="form-group">
                                                            <h4 style="padding:5px 0">Assignment #:</h4>
                                                            <select class="form-control lb-lg" name="marking_assignment_number" id="marking_assignment_number">
                                                    ...
                                                    <div class="col-md-4 no-padding">
                                                        <div class="form-group">
                                                            <h4 style="padding:5px 0">Upload File</h4>
                                                            <input type="file" id="marking_uploaded_file" name="marking_uploaded_file"/>
                                                            <small class="text-danger error_msg"
                                                                   id="marking_uploaded_file_errors"></small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <input type="hidden" id="method" name="method"
                                                   value="admin_marking_assignment_upload"/>
                                            <div class="col-md-12">
                                                <hr/>
                                                <input class="btn btn-primary" type="submit" id="confirmed_admin_marking_upload"
                                                       name="confirmed_admin_marking_upload" value="Submit"/>
                                                <input type="hidden" id="assignment_marking_course_id" name="assignment_marking_course_id"
                                                       value=""/>
                                                <input type="hidden" id="assignment_marking_course_type" name="assignment_marking_course_type"
                                                       value="work"/>
                                                <input type="hidden" id="assignment_marking_student_id" name="assignment_marking_student_id"
                                                       value=""/>
    ...
    <script type="text/javascript">
        ...
        function showReviewCourses(student_id) {
            console.log("SHOW ROWS for Student:" + student_id);
            $(".modal_review_courses_action").show();
        }
        ...
        (function () {
            ...
            $("#close_review_courses_dialog").on("click", function (e) {
                console.log("Cancelling review_courses");
                $(".modal_review_courses_action").hide();
            });

            $("#cancelled_review_courses").on("click", function (e) {
                console.log("Cancelling review_courses");
                $(".modal_review_courses_action").hide();
            });
                    ...
                    if(exploded[4] === 'work'){
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                console.log(response['total_assignments']);
                                //set values to edit tutor dialog fields
                                $("#edit_title").val(response['course_title']);

                                $('#assignment_marking_student_id').val(exploded[2]);
                                $('#assignment_marking_course_id').val(exploded[3]);
                                $('#assignment_marking_course_type').val(exploded[4]);

                                $("#marking_course_name").html('Course: <span class="text-muted">'+response['course_title']+"</span>");
                                $("#marking_student_name").html('Student: <span class="text-muted">'+response['student_name']+"</span>");
                                ...
                                $('#marking_assignment_number').html(html);
            ...
            //add course form submission code
            $("#confirmed_admin_marking_upload").click(function (e) {
                var error_scroll = '';
                //add rules
                //min length
                if ($('#marking_assignment_number').val().length <= 0) {
                    $('#marking_assignment_number_errors').text('Please select assignment number');
                    return false;
                } else {
                    $('#marking_assignment_number_errors').text('');
                }
                ...
                var formdata = new FormData($("#add_upload_for_marking_form")[0]);
                console.log("formdata");
                console.log(formdata);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        console.log('response');
                        console.log(response);
                        $('#success-alert').html('<h3>Assignment Uploaded</h3>');
                        $("#confirmed_admin_marking_upload").attr('disabled',true);
                        $('#success-alert').focus();
                        $("#success-alert").fadeTo(2000, 500).slideUp(500, function () {
                            $("#success-alert").css("height", "0px");
                            $("#success-alert").css("display", "block");
