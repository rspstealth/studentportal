...
<div id="app">
    ...
    height: 36px;
    margin-left: -3px;" src="{{ url('/') }}/images/logo/final-logo.jpg" alt="coordinatorX"/>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle profile-logo" data-toggle="dropdown" role="button"
                ...
                <ul id="main-menu" class="main-menu">
                    ...
                    <li class="root-level">
                        <a href="announcement">
                            ...
                            <span style="">Announcements</span>
                        </a>
                    </li>

                    <!-- INSTITUTIONS EXAMS -->
                    <li class="root-level">
                        <a href="institution-exams">
                    ...
                    <li class="root-level">
                        <a href="academic_syllabus">
                            ...
                            <span style="">Syllabus</span>
                        </a>
                    </li>

                    <!-- CLASS -->
                    <li class="has-sub root-level">
                        <a id="class" class="menu_toggler" href="#">
                    ...
                    <!-- STUDENT -->
                    <li class="has-sub root-level">
                        <a id="students" class="menu_toggler" href="{{ url('/') }}">
                        ...
                        <ul class="sub-menu" id="students_ul">
                            <!-- STUDENT ADMISSION -->
                            <li>
                                <a href="{{ url('/students') }}/add-student">
                                    <i class="icon-dot-single"></i>
                                    <span> Add Student</span>
                                </a>
                            </li>
                            <li class="<?php (request()->segment(1) === 'students' ? (request()->segment(2) === 'category' ? (request()->segment(3) === 'list' ? print 'active' : print ''): print ''): print '');?>">
                                <a href="{{ url('/students') }}/category/list">
                            ...
                            <li class=" ">
                                <a href="{{ url('/students') }}/bulk-import">
                                    <i class="icon-dot-single"></i>
                    ...
                    <!-- TEACHER -->
                    <li class="has-sub root-level">
                        <a id="teachers" class="menu_toggler" href="#">
                            <i class="fas fa-user-tie"></i>
                            <span>Teachers</span>
                            <i class="fa fa-angle-down dropdown-b down-arrow"></i>
                        </a>
                        <ul class="sub-menu" id="teachers_ul">
                            <li>
                                <a href="{{ url('/teachers') }}/add-teacher">
                                    <i class="icon-dot-single"></i>
                            ...
                            <li>
                                <a href="{{ url('/teachers') }}/bulk-import">
                                    <i class="icon-dot-single"></i>
                                    <span>Add Bulk Teachers</span>
                                </a>
                            </li>
                            <li>
                    ...
                    {{--<li class="root-level">--}}
                        {{--<a href="">--}}
                            ...
                            {{--<span style="">Enquiries</span>--}}
                        {{--</a>--}}
                    {{--</li>--}}

                    <!--GENERATE ID CARDS-->
                    <li class="has-sub root-level">
                        <a id="idcards" class="menu_toggler" href="#">
                    ...
                    <!-- SUBJECT -->
                    <li class="has-sub root-level">
                        <a id="subjects" class="menu_toggler" href="#">
                    ...
                    <li class="root-level">
                        <a href="">
                            ...
                            <span style="">Class Schedules</span>
                        </a>
                    </li>
                    ...
                    <li class="root-level">
                        <a href="{{ url("/attendance/") }}">
                            ...
                            <span style="">Student Attendance</span>
                        </a>
                    </li>
                    ...
                    <li class="root-level">
                        <a href="{{ url("/staff-attendance/") }}">
                            <i class="icon-area-graph"></i>
                            <span style="">Staff Attendance</span>
                        </a>
                    </li>
                    ...
                    <li class="root-level has-sub">
                        <a id="managecbt" class="menu_toggler" href="#">
                    ...
                    <!-- EXAMS -->
                    <li class="root-level has-sub">
                        <a id="exam" class="menu_toggler" href="#">
                            <i class="icon-graduation-cap"></i>
                            <span style="">Exams</span>
                            <i class="fa fa-angle-down dropdown-b down-arrow"></i>
                        </a>
                    ...
                    <!-- ACCOUNTING -->
                    <li class="root-level has-sub">
                        <a id="Accounting" class="menu_toggler" href="#">
                    ...
                    <!-- SETTINGS -->
                    <li class="root-level has-sub">
                        <a id="setting" class="menu_toggler" href="#">
                            <i class="icon-cog3"></i>
...
//         $('#' + this.id).toggleClass('active');
        ...
        $('.has-sub a').click(function (e) {
            ...
            if(e.currentTarget.className == "menu_toggler"){
                e.preventDefault();
                //if li id is not empty, so assuming that it would be menu's main item so we can use toggle here
                $('#' + e.currentTarget.id + ' .down-arrow').toggleClass('rotate');
                //$('#' + this.id).toggleClass('active');
                $('#' + e.currentTarget.id + '_ul').toggle();
            }
        });
        ...
        $('.breadcrumb_type ul li').click(function (e) {
            ...
            e.preventDefault();
            console.log('P Event:'+$('#' + this.id).css('pointer-events'));

            if($('.breadcrumb_type ul li#basic_info').css('pointer-events') != 'none'){
                $('.breadcrumb_type ul li#basic_info').removeClass('active');
            }
            if($('.breadcrumb_type ul li#profile_info').css('pointer-events') != 'none'){
                $('.breadcrumb_type ul li#profile_info').removeClass('active');
            }
            if($('.breadcrumb_type ul li#profile_photo').css('pointer-events') != 'none'){
                $('.breadcrumb_type ul li#profile_photo').removeClass('active');
            }
